...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault(); // ✅ Prevents page reload and multiple triggers
    ...
    try {
      ...
      setTimeout(() => {
        if (res.data.job_profile === "ADMIN") navigate("/admin-dashboard");
        else if (
    ...
    >
      <Paper sx={{ padding: 4, width: 350 }}>
        <Typography
          ...
          align="center"
          mb={2}
          sx={{ color: "#6482AD", fontWeight: "bold" }}
        >
          Login
        </Typography>
